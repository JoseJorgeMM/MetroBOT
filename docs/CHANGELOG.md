...
- Each `RouteCard` shows an **Iniciar navegaci�n** button (only when the route has a walk segment).
...
- `src/components/RouteCards/RouteCard.tsx` (Iniciar navegaci�n + ShareButton + nav state)
