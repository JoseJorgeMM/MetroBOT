...
(async () => {
  ...
  let rows = [];
  try { rows = JSON.parse(r.result.value); } catch (e) { console.log('parse failed:', e.message); console.log('raw:', r.result.value.slice(0,500)); process.exit(1); }
  console.log('viewport: 375x812 CSS');
